          ...
          <div className="px-2 pt-2">
            ...
            <div className="mt-0.5 space-y-0.5">
              ...
              <button
                ...
                className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-left transition-colors ${
                  mainView === "instagram"
                    ? "bg-[#1c1c1f] text-zinc-300"
                    : "text-zinc-600 hover:bg-[#161618] hover:text-zinc-400"
                }`}
              >
                <Camera className="w-3.5 h-3.5 shrink-0" />
                <span className="text-[12px] flex-1">Instagram</span>
                <span className="text-[9px] uppercase tracking-wider text-zinc-600 border border-[#27272a] rounded-full px-1.5 py-0.5 shrink-0">
                  Soon
                </span>
              </button>
              )}
    ...
    <div className="flex items-center justify-center h-full">
      <div className="w-full max-w-md px-6">
        <div className="bg-[#111113] border border-[#1f1f22] rounded-xl p-6 text-center">
          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-600/40 to-pink-500/40 flex items-center justify-center mx-auto mb-4">
            <Camera className="w-5 h-5 text-white/70" />
          </div>
          <p className="text-sm font-semibold text-white">Instagram — coming soon</p>
          <p className="text-xs text-zinc-500 mt-1.5 leading-relaxed">
            Instagram support is blocked pending Meta&apos;s developer verification. It&apos;ll light up
            here as soon as access is approved — nothing to do on your end.
          </p>
        </div>
      </div>
    </div>
