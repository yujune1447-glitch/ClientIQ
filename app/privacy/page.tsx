      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm text-zinc-400 leading-relaxed">
          <section>
            ...
            <p>
              Listvin is a content intelligence tool for creators. This policy explains what data Listvin
              ...
              contact us at{" "}
              <a href="mailto:privacy@listvin.app" className="text-zinc-300 hover:text-white underline transition-colors">
                privacy@listvin.app
              </a>
              .
            </p>
          ...
          <section>
            ...
            <p>
              Listvin uses YouTube API Services. By connecting your YouTube account and using Listvin, you
              ...
              . Information Listvin receives from YouTube API Services is handled in accordance with the{" "}
              <a
          ...
          <section>
            ...
            <p>
              When you connect your YouTube account, Listvin requests read-only access using the{" "}
            ...
            <ul className="mt-3 space-y-1.5 list-disc list-inside text-zinc-500">
              ...
              <li>Your Google account email address — used only to identify your Listvin account</li>
            </ul>
            <p className="mt-3">
              We access this data <span className="text-zinc-300">solely to generate your own content
              recommendations and weekly brief</span> inside Listvin. We do not access data for any channel
              you do not own, and we request read-only access only — Listvin never modifies, uploads, or
          ...
          <section>
            ...
            <p>
              ...
              in the United States. Google OAuth tokens are stored so Listvin can refresh your channel data
            ...
            <p className="mt-3">
              ...
              do <span className="text-zinc-300">not</span> use it for advertising, and neither Listvin nor
          ...
          <section>
            ...
            <p>
              Listvin&apos;s use and transfer of information received from Google APIs to any other app will
              adhere to the{" "}
              <a
          ...
          <section>
            ...
            <p>
              You can revoke Listvin&apos;s access to your Google/YouTube account at any time from your
              ...
              . You can also disconnect a platform from within your Listvin account settings. Revoking
          ...
          <section>
            ...
            <p>
              ...
              YouTube account or stop using Listvin, the associated Google/YouTube data and OAuth tokens are
          ...
          <section>
            ...
            <p>
              ...
              before the changes take effect. Continued use of Listvin after that date constitutes
